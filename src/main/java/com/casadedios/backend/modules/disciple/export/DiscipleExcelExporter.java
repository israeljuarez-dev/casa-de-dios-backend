package com.casadedios.backend.modules.disciple.export;
...
public class DiscipleExcelExporter  implements ExcelExportService {
    ...
    private String formatSpiritualLevel(SpiritualLevel level) {
    ...
    private String formatInviter(DiscipleInviterResponseDto inviter) {
